...
function CourseList() {
  ...
  return (
    <div>
      <NavMenu/>
      <div className="mt-5">
        <h1 className='fw-bold mb-4 text-center'>Cursos Disponibles</h1>
        <div className="mx-5">
          {loading ? (
            ...
            <div>
              <div className="input-group mb-4 w-50">
                ...
                <input type="text" className="form-control" placeholder="Buscar Cursos..." aria-label="Buscar Cursos..." aria-describedby="basic-addon1" value={query} onChange={handleSearch} />
              </div>
              {results.length > 0 ? (

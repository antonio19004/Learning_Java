                        ...
                        <div className="row mb-3">
                            <div className="col-md-6">
                                <div className="form-group mb-3">
                                    ...
                                    <input type="file" className="form-control" name="coverImage" onChange={handleImageChange} ref={fileInputRef} />
                                    {course.imagePreview && (
                                        <div className="position-relative mt-2">
                                            <img src={course.imagePreview} alt="Imagen del curso" style={{ width: '100px', height: '100px', objectFit: 'cover', borderRadius: '50px' }} />
                            ...
                            <div className="d-flex flex-wrap">
                                {availableTopic.map((topic, index) => (
                                    <div key={index} className="form-check me-4">
                                        <input type="checkbox" className="form-check-input" id={topic} name={topic} checked={course.topic.includes(topic)} onChange={handleCheckboxChange} />

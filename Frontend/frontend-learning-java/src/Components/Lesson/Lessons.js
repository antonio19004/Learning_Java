                        ...
                        <div className='shadow bg-light px-5 pb-5 pt-5 rounded'>
                            <div>
                                ...
                                {lessons && lessons.length > 0 ? (
                                    ...
                                    <div className="cursor-pointer d-flex justify-content-between p-3 mt-4 shadow bg-light rounded" onClick={() => handleCardClick(Lesson.id)} key={Lesson.id}>
                                        ...
                                        <div className='d-flex justify-content-between'>
                                            ...
                                            <div>
                                                {selectedLesson?.video ? (
                                                    <img src={`https://img.youtube.com/vi/${extractYoutubeId(selectedLesson.video)}/hqdefault.jpg`} alt={selectedLesson?.title} width="100" height="80" className="mb-3 border rounded" />
                                                ) : (

                        ...
                        <div>
                            ...
                            <div className="form-check form-switch">
                                                    <input
                                                        ...
                                                        type="checkbox"
                                                        id={`lessonCheckbox${currentIndex}`}
                                                        checked={completedLessons.has(lessons[currentIndex].id)}
                                                        onChange={() => handleCheckboxChange(lessons[currentIndex].id)}
                                                    />
                                                    <label
                                                        className="form-check-label text-muted fs-sm"
                                                        htmlFor={`lessonCheckbox${currentIndex}`}
                                                    >
